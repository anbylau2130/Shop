...
{
    public class CommodityBll : ICommodityBll
    {

        ICommodityDal dal;

        public CommodityBll(ICommodityDal dal)
        {
            this.dal = dal;
        ...
        public AjaxResult Add(Commodity model)
        {
            AjaxResult result = new AjaxResult();
        ...
        public AjaxResult Edit(Commodity model, long @operator)
        {
            AjaxResult result = new AjaxResult();
        ...
        public List<SelectOption> GetCommodityList(long id)
        {
        ...
        public DataGrid<UP_ShowCommodity_Result> GetAll(int? pageIndex, int? pageSize, string whereStr, string strOrder, string strOrderType)
        {
            DataGrid<UP_ShowCommodity_Result> result = new DataGrid<UP_ShowCommodity_Result>();
