    ...
    public class NopiExcelHelper
    {
        ...
        public static MemoryStream Export(DataTable dtSource, string strHeaderText, string strSheetName, string[] oldColumnNames, string[] newColumnNames)
        {
            ...
            #region 右击文件 属性信息
            {
                ...
                //if (currentUser.SysCorp != null)
                //{
                //    dsi.Company = currentUser.SysCorp.Name;
                //}
                ...
                //if (!string.IsNullOrEmpty(currentUser.SysOperator.RealName))
                //{
                //    si.Author = currentUser.SysOperator.RealName;
                //}
                //else
                //{
                //    if (!string.IsNullOrEmpty(currentUser.SysOperator.LoginName))
                //    {
                //        si.Author = currentUser.SysOperator.LoginName;
                //    }
                //}                                       //填加xls文件作者信息     
        ...
        public static byte[] ExportByWeb(DataTable dtSource, string strHeaderText)
        {
          return  ExportByWeb(dtSource, strHeaderText, "sheet");
        }
        ...
        public static byte[] ExportByWeb(DataTable dtSource, string strHeaderText, string[] oldColumnNames, string[] newColumnNames)
        {
            return ExportByWeb(dtSource, strHeaderText,  "sheet", oldColumnNames, newColumnNames);
        }
        ...
        /// <param name="strSheetName">工作表名称</param>  
        public static byte[] ExportByWeb(DataTable dtSource, string strHeaderText,  string strSheetName)
        {
        ...
        /// <param name="oldColumnNames">要导出的DataTable列数组</param>  
        /// <param name="newColumnNames">导出后的对应列名</param>  
        public static byte[] ExportByWeb(DataTable dtSource, string strHeaderText,  string strSheetName, string[] oldColumnNames, string[] newColumnNames)
        {
            //HttpContext curContext = HttpContext.Current;
        ...
        /// <summary>  
        /// 从Excel中获取所有sheet到多个DataTable  
        /// </summary>  
        /// <param name="excelFileStream">Excel文件流</param>  
        /// <param name="sheetcount">sheet数量</param>
        /// <returns></returns>  
        public static List<DataTable> RenderAllDataTableFromExcel(Stream excelFileStream, int sheetcount)
        {
            ...
            for (var i = 0; i < sheetcount; i++)
            {
                ...
                dts.Add(RenderDataTableFromExcel(workbook, sheetName, 0));
            }
            return dts;
        }
